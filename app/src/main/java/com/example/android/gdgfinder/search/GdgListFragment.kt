...
class GdgListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        //  Create an observer on viewModel.regionList. Override the required
        ...
        //  Use the map() function to create a Chip for each item in regionList and
        // return the results as a new list called children.

        //  Call chipGroup.removeAllViews() to remove any views already in chipGroup.
